...
parser.add_argument(
    ...
    help="SAC|DQN|PPO|ensemble_DQN|bootstrap_DQN|model_1_AI|model_1_AI_actor",
)
parser.add_argument(
    "--env",
...
if __name__ == "__main__":
    ...
    for i_episode in range(args.NUM_episodes):
        ...
        k=np.random.randint(0,args.NUM_ensemble)
        for t in count():
            steps_done += 1
            if args.foot_record:
                if steps_done < 20000:
            ...
            action, E, action_prob = agent.select_action(state,k=k)
